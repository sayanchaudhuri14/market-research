# NIFTY Gap Strategy — Live Paper Trading (v2 Baseline)
...
**Signal version**: v2 baseline — SGX signal uses `NKD=F` D-1 daily close return.
See `cron/v4.3/` for the version that uses ^N225 trade-day Open (5:30 IST).
